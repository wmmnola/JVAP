 ...
 * @author  Daniel
 */
public class vstgui extends jvst.wrapper.VSTPluginGUIAdapter {
    ...
    public vstgui(VSTPluginGUIRunner r, VSTPluginAdapter plug) {
        ...
        settingsdlg=new editsettings(this);

    this.setTitle("Scripteffect v0.3");
    this.setSize(550, 629);
    this.setResizable(false);

    this.init((org.jvaptools.scripteffect.vstmain)plug);
    ...
    private void initComponents() {
        ...
        ButtonArea.setBorder(new javax.swing.border.EtchedBorder());
...
// TODO add your handling code here:
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        ...
        if((!cancel)&&(file==null)) {
           ...
           public boolean accept(java.io.File f){
               return (f.getName().endsWith(".scr"))||f.isDirectory();
           }
        ...
        chooser.setSelectedFile(new java.io.File("script.scr"));
    ...
    private void LoadButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoadButtonActionPerformed
        ...
        FileFilter filter = new FileFilter() {
           public boolean accept(java.io.File f){
               return (f.getName().endsWith(".txt")||f.getName().endsWith(".scr"))||f.isDirectory();
           }
           public String getDescription() {
               return "script files";
           }
...
// TODO add your handling code here:
          ...
          public void run() {
            ...
            try{
               org.codehaus.janino.Scanner scanner=new org.codehaus.janino.Scanner(null,
                ...
                s=(PluginScript)org.codehaus.janino.ClassBodyEvaluator.createFastClassBodyEvaluator(scanner,PluginScript.class,
    ...
    org.jvaptools.scripteffect.vstmain pPlugin=null;
    ...
    public void init(jvst.wrapper.VSTPluginAdapter e) {
       this.pPlugin = (org.jvaptools.scripteffect.vstmain)e;
       if(this.pPlugin!=null) {
